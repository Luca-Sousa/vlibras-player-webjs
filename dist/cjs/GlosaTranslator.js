...
exports.GlosaTranslator = void 0;
const config_1 = require("./config");
/**
 * Classe responsável por traduzir texto para glosa (linguagem de sinais)
 */
class GlosaTranslator {
    constructor(translatorUrl = config_1.config.translatorUrl, timeout = config_1.config.requestTimeout) {
...
exports.GlosaTranslator = GlosaTranslator;
